...
\begin{document}
	...
	\section{Summary}
	In this chapter we have discussed works related to the domains of few-shot and continuous learning, and considered their feasibility to be extended to the joint-task of few-shot continuous learning. A summary of the results are shown in figure \ref{fig:table:1}, where we see that there is no technique which yields ideal results. \par
	The primary reason for none solving the task at hand is that this a rather un-addressed -- yet important -- class of machine-learning problems. Having recognised the shortcomings of other approaches, in the next chapter we will propose a solution which attempts to address the outlined concerns. \par
	\begin{figure}[h]
		\centering
		\includegraphics[width=20cm]{table}
