...
\begin{document}
	...
	%TODO WORDS
	Mean-squared error is used for regression tasks, where the objective is to predict a value - or set of values - whereby the target is a quantitative value rather than a measure of probability. L2 loss is ideal for tasks of this sort as when modelling a noisy relationship between inputs and outputs,  TODO WORDS. \\
