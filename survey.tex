...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Model-based}: A specific model architecture designed to handle few-shot problems by utilising some kind of memory unit -- typically an RNN (section \ref{rnn:1}) or memory-network (section \ref{memory-nets:1}).
