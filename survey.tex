...
\begin{document}
	...
	\begin{itemize}
		...
		\item\textbf{Momentum on multiple time-scales}: By providing the optimizer with exponential moving averages of the gradients on several time-scales, the meta-leaner has access to information about how rapidly the gradient is changing and about the degree of noise in the gradient.
	...
	\caption{\textit{Learned Optimizers that Scale and Generalize} architecture}
