...
\begin{document}
	...
	\FEEDBACK{The related works chapter needs to gradually build up an argument on what is missing in the literature which leads to your proposal.}
	...
	\FEEDBACK{You should not be citing headings. It should be like He et. al. CITATION developed a solution that does this and that and this, etc.}
	...
	\FEEDBACK{Sorry but these last 3 sentences are really hard to understand can you try to reword them? Not really sure what your point is. However, it is good to have analysis of the cons of the technique.}
