...
\begin{document}
	...
	\end{align}	
	While not the most recent (I will omit a few other adaptive optimizers), Adam is rapidly becoming the most frequently used optimizer for its consistent convergence and ease-of-use.
