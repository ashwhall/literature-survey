...
\begin{document}
	...
	\begin{itemize}
		\item\textbf{Neurosynaptic plasticity} - The brain is particularly plastic during early development, allowing for sense-driven changes to occur on a large scale. Plasticity decreases with increasing age, making the brain more stable
	\end{itemize}
	\TODO{Week 4}
